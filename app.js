...
function applyLanguage(lang=state.settings.language||'ko'){
  ...
  setText('#today .section-head h2',t.daily);setText('#mealPlanHeading',t.meal);setText('#dashboardRecentRunsHeading',t.recent);setText('#workoutHeading',t.workout);setText('#today .section-head:nth-last-of-type(2) h2',t.quick);setText('#today .section-head:last-of-type h2',t.latest);setText('#runStatusTitle',t.ready);setText('#startRunBtn',t.start);setText('#run .section-head:last-of-type h2',t.recent);setText('#plan .plan-title-row h2',t.weekly);setText('#progress .section-head h2',t.body);setText('#settings .section-head:nth-last-of-type(1) h2',t.data);setText('#saveSettingsBtn',t.save);setText('.story-studio-note',t.storyNote);
...
function renderRun(){
  ...
  if(!r){
    ...
    runEls.title.textContent=r.autoPaused?'Auto paused':(r.activityType==='walk'?(state.settings.language==='ko'?'걷기 진행 중':'Walk in progress'):(state.settings.language==='ko'?'러닝 진행 중':'Run in progress'));
