...
function render(){applyTheme(state.settings.theme||'performance');updateGreeting();renderToday();renderPlan();renderCalendar();renderProgress();renderSettings()}
function renderPlan(){
